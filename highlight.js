...
AFRAME.registerComponent('highlight', {
  ...
  onClick: function (evt) {
    evt.target.pause();
    evt.target.setAttribute('material', 'color', '#E406F8');
  ...
  onMouseEnter: function (evt) {
    ...
    evt.target.setAttribute('material', 'color', '#F7420C');
    for (var i = 0; i < buttonEls.length; ++i) {
  ...
  reset: function () {
    ...
    window.open("https://view.genially.com/66524e43c08cb40014d8a425/interactive-content-escape-room-reinos-de-la-naturaleza");
  }
});
